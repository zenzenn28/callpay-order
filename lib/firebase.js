...
function toFirestoreValue(val) {
  // Fix: Firestore REST API butuh "NULL_VALUE" bukan null
...
function fromFirestore(fields = {}) {
  ...
  for (const [k, v] of Object.entries(fields)) {
    ...
    else if (v.arrayValue   !== undefined) obj[k] = (v.arrayValue.values || []).map(fromFirestoreValue);
    else if (v.mapValue     !== undefined) obj[k] = fromFirestore(v.mapValue.fields || {});
    else obj[k] = null;
  }
  return obj;
}
